...
const requiredResponseSchemas = [
  ...
  ['post', '/v1/sessions', 'StartedSessionResponseDto'],
...
const requiredSchemaProperties = {
  ...
  CompetitionRulesResponseDto: [
    ...
    'requireGymQr',
    'signupPrizeDrawEntries',
    'verifiedSessionCategoryScore',
    'verifiedSessionPrizeDrawEntries',
