    ...
    <ScreenContainer>
      ...
      >
        ...
        <TerminalText style={styles.body} tone="muted" uppercase={false} variant="body">
          Open any screen with a verified test identity, approved region,
          completed legal receipt and active competition enrollment. Actions
          stay in memory and never call the GoGymGo backend.
        </TerminalText>
