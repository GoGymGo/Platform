...
export interface components {
  schemas: {
    ...
    RewardWinnerResponseDto: { alias: string; awardRank: number; cashAmountCents: number | null; cashCurrency: string | null; rewardTitle: string; rewardType: "cash" | "coupon" | "physical"; sponsorName: string; streaks: components['schemas']["StreakCountsDto"] };
