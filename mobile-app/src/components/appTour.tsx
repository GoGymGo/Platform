...
export function AppTourModeBanner() {
  ...
  return (
    <View accessibilityLabel="App Tour screen navigation" style={styles.shortcut}>
      <TourStepButton
      ...
      />
      <Pressable
        accessibilityHint="Open the development App Tour screen directory"
        accessibilityLabel="Testing mode is active. Open App Tour."
        accessibilityRole="button"
        onPress={() => {
          enterTour('ready');
          router.replace('/app-tour?appTour=1');
        }}
        style={({ pressed }) => [
