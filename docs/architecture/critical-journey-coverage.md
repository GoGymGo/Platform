...
| Results and rewards      | Settled results, awards and claims remain one connected response path                       | Pending results settle, awards load, and a repeated claim returns the same outcome             | A published reward is required before contest publication                     |
