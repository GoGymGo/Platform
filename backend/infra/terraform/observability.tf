...
resource "google_monitoring_alert_policy" "readiness" {
  ...
  documentation {
    ...
    content   = "The public readiness endpoint checks both PostgreSQL and the durable operations-worker heartbeat. Follow backend/docs/deployment-runbook.md before restarting or replaying work."
  }
}
